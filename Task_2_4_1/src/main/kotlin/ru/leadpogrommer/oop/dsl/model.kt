...
data class Student(val nickname: String, val name: String, val repo: URL, val branch: String, val assignments: List<Assignment>,val taskBranches: Map<String, String>, val useRootProject: Boolean)
